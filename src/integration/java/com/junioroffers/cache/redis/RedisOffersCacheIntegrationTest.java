...
class RedisOffersCacheIntegrationTest extends BaseIntegrationTest {
    ...
    public void should_save_offers_to_cache_and_then_invalidate_by_time_to_live() throws Exception {
        ...
        // (within 4 seconds cache should be invalidated at least twice as time-to-live is set to one second, which means findAllOffers() should be invoked at least two times)
        // given && when && then
        await()
